...
- **ssid** [-s] (optional, default = [settings ssid](https://github.com/mastersubhajit/CyberDrone/blob/master/settings.md#ssid)): Network name.  
- **password** [-pswd] (optional, default = [settings password](https://github.com/mastersubhajit/CyberDrone/blob/master/settings.md#password)): Password.  
- **channel** [-ch] (optional, default = [settings channel](https://github.com/mastersubhajit/CyberDrone/blob/master/settings.md#channel)): Channel .  
- **hidden** [-h] (optional, default = [settings hidden](https://github.com/mastersubhajit/CyberDrone/blob/master/settings.md#hidden)): Hide SSID.  
- **captiveportal** [-cp] (optional, default = [settings captiveportal](https://github.com/mastersubhajit/CyberDrone/blob/master/settings.md#captiveportal)): Enable captiveportal.  
